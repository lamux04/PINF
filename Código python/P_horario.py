...
Clases.append(clase("Mecánica y Vibraciones B1 Problemas","Problemas",sem,60,"NO",vibra,FranciscosFndz))
Clases.append(clase("Mecánica y Vibraciones B2 Problemas","Problemas",sem,60,"NO",vibra,FranciscosFndz))
Clases.append(clase("Mecánica y Vibraciones C1/C3 Prácticas Informáticas","Prácticas",pi,120,"NO",vibra,FranciscosFndz))
...
Clases.append(clase("Materiales Aerospaciales B1 Problemas","Problemas",mp,120,"NO",mataero,LuisRubio))
...
v3.colocarClases(Clases, Aulas, Horarios, 510, 1260, 840, 915)
