...
class c_horario:
    ...
    def mostrar(self):
        print("-----------------------------------------")
        self.clase.mostrar()
        print(f"Hora de inicio: ", end = "")
        if(int(self.h_ini/60)) < 10:
            print(f"0{int(self.h_ini/60)}:", end="")
        else:
            print(f"{int(self.h_ini/60)}:", end="")
        if(int(self.h_ini%60)) < 10:
            print(f"0{int(self.h_ini%60)}, y hora de fin: ", end="")
        else:
            print(f"{int(self.h_ini%60)}, y hora de fin: ", end="")
